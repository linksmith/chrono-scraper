...
# Legacy Page model removed - using shared pages architecture
...
class MeilisearchService:
    ...
    def _prepare_document_legacy_disabled(self):
        """Legacy function disabled - Page model removed"""
        raise MeilisearchException("Legacy Page model removed - use shared pages architecture")
            'id': f'page_{page.id}',
            'page_id': page.id,
